...
import com.malimar.controllers.EmpHourlyController;
...
public class FrmEmpHourly extends javax.swing.JDialog {
    
    public FrmEmpHourly(java.awt.Frame parent, boolean modal, int emid, String emNbr, String emName) {
        super(parent, modal);
        initComponents();
        EmpHourlyController ac = new EmpHourlyController(this, emid, emNbr, emName);
    }

    public JLabel getLblHourlyInfo() {
        return lblHourlyInfo;
    }
    ...
    public JTextField getTxtHourlyAmount() {
        return txtHourlyAmount;
    }

    public JTextField getTxtHourlyID() {
        return txtHourlyID;
    }
    ...
    private void initComponents() {
        ...
        lblHrsAmount = new javax.swing.JLabel();
        txtHourlyAmount = new javax.swing.JTextField();
        ...
        txtHourlyID.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 1, 0, new java.awt.Color(160, 160, 160)));
        txtHourlyID.setDisabledTextColor(new java.awt.Color(0, 0, 0));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "lblHourlyID", "lblDate", "lblHrsAmount", "lblHours", "lblMinute", "lblTotal", "lblMgr", "lblHR"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FrmEmpHourly.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FrmEmpHourly dialog = new FrmEmpHourly(new javax.swing.JFrame(), true, 0, null, null);
    ...
    private javax.swing.JLabel lblHrsAmount;
    ...
    private javax.swing.JTextField txtHourlyAmount;
    private javax.swing.JTextField txtHourlyID;
