...
public class FrmMainMenu extends javax.swing.JFrame {
    ...
    public JLabel getMenuAbsentTypeGH() {
        return menuAbsentTypeGH;
    }

    public JLabel getMenuBankG() {
        return menuBankG;
    }

    public JLabel getMenuBankGH() {
        return menuBankGH;
    }

    public JLabel getMenuCompanyG() {
        return menuCompanyG;
    }

    public JLabel getMenuCompanyGH() {
        return menuCompanyGH;
    }

    public JLabel getMenuDeductionTypeG() {
        return menuDeductionTypeG;
    }

    public JLabel getMenuDeductionTypeGH() {
        return menuDeductionTypeGH;
    }

    public JLabel getMenuDepartmentG() {
        return menuDepartmentG;
    }

    public JLabel getMenuDepartmentGH() {
        return menuDepartmentGH;
    }

    public JLabel getMenuDivisionG() {
        return menuDivisionG;
    }

    public JLabel getMenuDivisionGH() {
        return menuDivisionGH;
    }

    public JLabel getMenuEmpStatusG() {
        return menuEmpStatusG;
    }

    public JLabel getMenuEmpStatusGH() {
        return menuEmpStatusGH;
    }

    public JLabel getMenuEthnicG() {
        return menuEthnicG;
    }

    public JLabel getMenuEthnicGH() {
        return menuEthnicGH;
    }

    public JLabel getMenuInsuranceG() {
        return menuInsuranceG;
    }

    public JLabel getMenuInsuranceGH() {
        return menuInsuranceGH;
    }

    public JLabel getMenuLocationG() {
        return menuLocationG;
    }

    public JLabel getMenuLocationGH() {
        return menuLocationGH;
    }

    public JLabel getMenuNationalityG() {
        return menuNationalityG;
    }

    public JLabel getMenuNationalityGH() {
        return menuNationalityGH;
    }

    public JLabel getMenuOverTimeTypeG() {
        return menuOverTimeTypeG;
    }

    public JLabel getMenuOverTimeTypeGH() {
        return menuOverTimeTypeGH;
    }

    public JLabel getMenuReligionG() {
        return menuReligionG;
    }

    public JLabel getMenuReligionGH() {
        return menuReligionGH;
    }

    public JLabel getMenuSalaryTypeG() {
        return menuSalaryTypeG;
    }

    public JLabel getMenuSalaryTypeGH() {
        return menuSalaryTypeGH;
    }

    public JLabel getMenuTitleG() {
        return menuTitleG;
    }

    public JLabel getMenuTitleGH() {
        return menuTitleGH;
    }

    public JLabel getMenuUnitWorkG() {
    ...
    public JocHyperlink getMenuMinimum() {
        return menuMinimum;
    }
    ...
    public JocHyperlink getMenuBank() {
        return menuBank;
    }

    public JocHyperlink getMenuCompany() {
        return menuCompany;
    }

    public KButton getMenuDashboard() {
        return menuDashboard;
    }

    public JocHyperlink getMenuDeductionType() {
        return menuDeductionType;
    }

    public JocHyperlink getMenuDepartment() {
        return menuDepartment;
    }

    public JocHyperlink getMenuDivision() {
        return menuDivision;
    }

    public JocHyperlink getMenuEmpStatus() {
    ...
    public JocHyperlink getMenuFacebook() {
        return menuFacebook;
    }

    public JocHyperlink getMenuGoogle() {
        return menuGoogle;
    }

    public KButton getMenuHR() {
        return menuHR;
    }

    public JocHyperlink getMenuInsurance() {
    ...
    public JocHyperlink getMenuNationality() {
    ...
    public JocHyperlink getMenuUnitWork() {
        return menuUnitWork;
    }
    ...
    private void initComponents() {
        ...
        lblLaoERP = new javax.swing.JLabel();
        menuExit = new com.xzq.osc.JocHyperlink();
        jPanel2 = new javax.swing.JPanel();
        menuDashboard = new com.malimar.utils.KButton();
        menuHR = new com.malimar.utils.KButton();
        menuSetting = new com.malimar.utils.KButton();
        lblUserlogin = new javax.swing.JLabel();
        menuMaximum = new com.xzq.osc.JocHyperlink();
        menuMinimum = new com.xzq.osc.JocHyperlink();
        panelSideMenu = new javax.swing.JPanel();
        jPanel1 = new javax.swing.JPanel();
        lblMainData = new javax.swing.JLabel();
        menuCompany = new com.xzq.osc.JocHyperlink();
        menuLocation = new com.xzq.osc.JocHyperlink();
        menuDivision = new com.xzq.osc.JocHyperlink();
        menuDepartment = new com.xzq.osc.JocHyperlink();
        menuUnitWork = new com.xzq.osc.JocHyperlink();
        menuTitle = new com.xzq.osc.JocHyperlink();
        menuNationality = new com.xzq.osc.JocHyperlink();
        menuEthnic = new com.xzq.osc.JocHyperlink();
        menuReligion = new com.xzq.osc.JocHyperlink();
        menuBank = new com.xzq.osc.JocHyperlink();
        menuInsurance = new com.xzq.osc.JocHyperlink();
        menuEmpStatus = new com.xzq.osc.JocHyperlink();
        menuAbsentType = new com.xzq.osc.JocHyperlink();
        menuOverTimeType = new com.xzq.osc.JocHyperlink();
        menuSalaryType = new com.xzq.osc.JocHyperlink();
        menuDeductionType = new com.xzq.osc.JocHyperlink();
        menuGoogle = new com.xzq.osc.JocHyperlink();
        menuYoutube = new com.xzq.osc.JocHyperlink();
        menuFacebook = new com.xzq.osc.JocHyperlink();
        menuCompanyG = new javax.swing.JLabel();
        menuLocationG = new javax.swing.JLabel();
        menuDivisionG = new javax.swing.JLabel();
        menuDepartmentG = new javax.swing.JLabel();
        menuUnitWorkG = new javax.swing.JLabel();
        menuTitleG = new javax.swing.JLabel();
        menuNationalityG = new javax.swing.JLabel();
        menuEthnicG = new javax.swing.JLabel();
        menuReligionG = new javax.swing.JLabel();
        menuBankG = new javax.swing.JLabel();
        menuInsuranceG = new javax.swing.JLabel();
        menuEmpStatusG = new javax.swing.JLabel();
        menuAbsentTypeG = new javax.swing.JLabel();
        menuOverTimeTypeG = new javax.swing.JLabel();
        menuSalaryTypeG = new javax.swing.JLabel();
        menuDeductionTypeG = new javax.swing.JLabel();
        menuCompanyGH = new javax.swing.JLabel();
        menuLocationGH = new javax.swing.JLabel();
        menuDivisionGH = new javax.swing.JLabel();
        menuDepartmentGH = new javax.swing.JLabel();
        menuUnitWorkGH = new javax.swing.JLabel();
        menuTitleGH = new javax.swing.JLabel();
        menuNationalityGH = new javax.swing.JLabel();
        menuEthnicGH = new javax.swing.JLabel();
        menuReligionGH = new javax.swing.JLabel();
        menuBankGH = new javax.swing.JLabel();
        menuInsuranceGH = new javax.swing.JLabel();
        menuEmpStatusGH = new javax.swing.JLabel();
        menuAbsentTypeGH = new javax.swing.JLabel();
        menuOverTimeTypeGH = new javax.swing.JLabel();
        ...
        menuDashboard.setkBorderRadius(0);
        menuDashboard.setkEndColor(new java.awt.Color(81, 87, 99));
        menuDashboard.setkHoverEndColor(new java.awt.Color(65, 65, 81));
        menuDashboard.setkHoverForeGround(new java.awt.Color(255, 255, 255));
        menuDashboard.setkHoverStartColor(new java.awt.Color(65, 65, 81));
        menuDashboard.setkIndicatorThickness(0);
        menuDashboard.setkPressedColor(new java.awt.Color(65, 65, 81));
        menuDashboard.setkSelectedColor(new java.awt.Color(65, 65, 81));
        menuDashboard.setkStartColor(new java.awt.Color(81, 87, 99));
        menuDashboard.setMaximumSize(new java.awt.Dimension(119, 50));
        menuDashboard.setMinimumSize(new java.awt.Dimension(119, 50));
        ...
        menuHR.setkBorderRadius(0);
        menuHR.setkEndColor(new java.awt.Color(81, 87, 99));
        menuHR.setkHoverEndColor(new java.awt.Color(65, 65, 81));
        menuHR.setkHoverForeGround(new java.awt.Color(255, 255, 255));
        menuHR.setkHoverStartColor(new java.awt.Color(65, 65, 81));
        menuHR.setkIndicatorThickness(0);
        menuHR.setkPressedColor(new java.awt.Color(65, 65, 81));
        menuHR.setkSelectedColor(new java.awt.Color(65, 65, 81));
        menuHR.setkStartColor(new java.awt.Color(81, 87, 99));
        menuHR.setMaximumSize(new java.awt.Dimension(119, 50));
        menuHR.setMinimumSize(new java.awt.Dimension(119, 50));
        menuHR.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
        ...
        menuSetting.setkBorderRadius(0);
        menuSetting.setkEndColor(new java.awt.Color(81, 87, 99));
        menuSetting.setkHoverEndColor(new java.awt.Color(65, 65, 81));
        menuSetting.setkHoverForeGround(new java.awt.Color(255, 255, 255));
        menuSetting.setkHoverStartColor(new java.awt.Color(65, 65, 81));
        menuSetting.setkIndicatorThickness(0);
        menuSetting.setkPressedColor(new java.awt.Color(65, 65, 81));
        menuSetting.setkSelectedColor(new java.awt.Color(65, 65, 81));
        menuSetting.setkStartColor(new java.awt.Color(81, 87, 99));
        menuSetting.setMaximumSize(new java.awt.Dimension(119, 50));
        menuSetting.setMinimumSize(new java.awt.Dimension(119, 50));
        ...
        lblUserlogin.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/icons/User_30px.png"))); // NOI18N
        lblUserlogin.setText("meexiong.2018@gmail.com");

        menuMaximum.setActiveColor(new java.awt.Color(255, 50, 50));
        menuMaximum.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/icons/Maximize Window_30px.png"))); // NOI18N
        menuMaximum.setUnvisitColor(new java.awt.Color(255, 255, 255));
        menuMaximum.setFont(new java.awt.Font("Saysettha OT", 1, 12)); // NOI18N

        menuMinimum.setActiveColor(new java.awt.Color(255, 50, 50));
        menuMinimum.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/icons/Minimize Window_30px.png"))); // NOI18N
        menuMinimum.setUnvisitColor(new java.awt.Color(255, 255, 255));
        menuMinimum.setFont(new java.awt.Font("Saysettha OT", 1, 12)); // NOI18N
        ...
        panelTitleLayout.setHorizontalGroup(
            ...
            .addGroup(panelTitleLayout.createSequentialGroup()
                ...
                .addGap(2, 2, 2)
                .addComponent(menuMaximum, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(2, 2, 2)
        ...
        panelTitleLayout.setVerticalGroup(
            ...
            .addGroup(panelTitleLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                ...
                .addComponent(menuMinimum, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.PREFERRED_SIZE, 0, Short.MAX_VALUE)
                .addComponent(lblUserlogin, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );

        getContentPane().add(panelTitle, java.awt.BorderLayout.PAGE_START);

        panelSideMenu.setBackground(new java.awt.Color(81, 87, 99));
        panelSideMenu.setPreferredSize(new java.awt.Dimension(200, 692));
        panelSideMenu.setLayout(null);

        jPanel1.setBackground(new java.awt.Color(65, 65, 81));

        lblMainData.setFont(new java.awt.Font("Saysettha OT", 1, 18)); // NOI18N
        lblMainData.setForeground(new java.awt.Color(255, 255, 255));
        lblMainData.setText("Main Data");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(lblMainData, javax.swing.GroupLayout.DEFAULT_SIZE, 180, Short.MAX_VALUE)
                .addContainerGap())
        );
        ...
        menuDeductionType.setBounds(10, 585, 180, 27);

        menuGoogle.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/icons/Chrome_30px.png"))); // NOI18N
        menuGoogle.setUnvisitColor(new java.awt.Color(255, 255, 255));
        menuGoogle.setFont(new java.awt.Font("Saysettha OT", 1, 12)); // NOI18N
        menuGoogle.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        panelSideMenu.add(menuGoogle);
        menuGoogle.setBounds(13, 5, 32, 32);

        menuYoutube.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/icons/Play Button_30px.png"))); // NOI18N
        menuYoutube.setUnvisitColor(new java.awt.Color(255, 255, 255));
        menuYoutube.setFont(new java.awt.Font("Saysettha OT", 1, 12)); // NOI18N
        menuYoutube.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        panelSideMenu.add(menuYoutube);
        menuYoutube.setBounds(59, 5, 32, 32);

        menuFacebook.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/icons/Facebook_30px.png"))); // NOI18N
        menuFacebook.setUnvisitColor(new java.awt.Color(255, 255, 255));
        menuFacebook.setFont(new java.awt.Font("Saysettha OT", 1, 12)); // NOI18N
        menuFacebook.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        panelSideMenu.add(menuFacebook);
        menuFacebook.setBounds(101, 5, 32, 32);

        menuCompanyG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenuHover.png"))); // NOI18N
        panelSideMenu.add(menuCompanyG);
        menuCompanyG.setBounds(6, 105, 189, 28);

        menuLocationG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenuHover.png"))); // NOI18N
        panelSideMenu.add(menuLocationG);
        menuLocationG.setBounds(6, 137, 189, 28);

        menuDivisionG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenuHover.png"))); // NOI18N
        panelSideMenu.add(menuDivisionG);
        menuDivisionG.setBounds(6, 169, 189, 28);

        menuDepartmentG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenuHover.png"))); // NOI18N
        panelSideMenu.add(menuDepartmentG);
        menuDepartmentG.setBounds(6, 201, 189, 28);

        menuUnitWorkG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenuHover.png"))); // NOI18N
        panelSideMenu.add(menuUnitWorkG);
        menuUnitWorkG.setBounds(6, 233, 189, 28);

        menuTitleG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenuHover.png"))); // NOI18N
        panelSideMenu.add(menuTitleG);
        menuTitleG.setBounds(6, 265, 189, 28);

        menuNationalityG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenuHover.png"))); // NOI18N
        panelSideMenu.add(menuNationalityG);
        menuNationalityG.setBounds(6, 297, 189, 28);

        menuEthnicG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenuHover.png"))); // NOI18N
        panelSideMenu.add(menuEthnicG);
        menuEthnicG.setBounds(6, 329, 189, 28);

        menuReligionG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenuHover.png"))); // NOI18N
        panelSideMenu.add(menuReligionG);
        menuReligionG.setBounds(6, 361, 189, 28);

        menuBankG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenuHover.png"))); // NOI18N
        panelSideMenu.add(menuBankG);
        menuBankG.setBounds(6, 393, 189, 28);

        menuInsuranceG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenuHover.png"))); // NOI18N
        panelSideMenu.add(menuInsuranceG);
        menuInsuranceG.setBounds(6, 425, 189, 28);

        menuEmpStatusG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenuHover.png"))); // NOI18N
        panelSideMenu.add(menuEmpStatusG);
        menuEmpStatusG.setBounds(6, 457, 189, 28);

        menuAbsentTypeG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenuHover.png"))); // NOI18N
        panelSideMenu.add(menuAbsentTypeG);
        menuAbsentTypeG.setBounds(6, 489, 189, 28);

        menuOverTimeTypeG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenuHover.png"))); // NOI18N
        panelSideMenu.add(menuOverTimeTypeG);
        menuOverTimeTypeG.setBounds(6, 521, 189, 28);

        menuSalaryTypeG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenuHover.png"))); // NOI18N
        panelSideMenu.add(menuSalaryTypeG);
        menuSalaryTypeG.setBounds(6, 553, 189, 28);

        menuDeductionTypeG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenuHover.png"))); // NOI18N
        panelSideMenu.add(menuDeductionTypeG);
        menuDeductionTypeG.setBounds(6, 585, 189, 28);

        menuCompanyGH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenu.png"))); // NOI18N
        panelSideMenu.add(menuCompanyGH);
        menuCompanyGH.setBounds(6, 105, 189, 28);

        menuLocationGH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenu.png"))); // NOI18N
        panelSideMenu.add(menuLocationGH);
        menuLocationGH.setBounds(6, 137, 189, 28);

        menuDivisionGH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenu.png"))); // NOI18N
        panelSideMenu.add(menuDivisionGH);
        menuDivisionGH.setBounds(6, 169, 189, 28);

        menuDepartmentGH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenu.png"))); // NOI18N
        panelSideMenu.add(menuDepartmentGH);
        menuDepartmentGH.setBounds(6, 201, 189, 28);

        menuUnitWorkGH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenu.png"))); // NOI18N
        panelSideMenu.add(menuUnitWorkGH);
        menuUnitWorkGH.setBounds(6, 233, 189, 28);

        menuTitleGH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenu.png"))); // NOI18N
        panelSideMenu.add(menuTitleGH);
        menuTitleGH.setBounds(6, 265, 189, 28);

        menuNationalityGH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenu.png"))); // NOI18N
        panelSideMenu.add(menuNationalityGH);
        menuNationalityGH.setBounds(6, 297, 189, 28);

        menuEthnicGH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenu.png"))); // NOI18N
        panelSideMenu.add(menuEthnicGH);
        menuEthnicGH.setBounds(6, 329, 189, 28);

        menuReligionGH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenu.png"))); // NOI18N
        panelSideMenu.add(menuReligionGH);
        menuReligionGH.setBounds(6, 361, 189, 28);

        menuBankGH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenu.png"))); // NOI18N
        panelSideMenu.add(menuBankGH);
        menuBankGH.setBounds(6, 393, 189, 28);

        menuInsuranceGH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenu.png"))); // NOI18N
        panelSideMenu.add(menuInsuranceGH);
        menuInsuranceGH.setBounds(6, 425, 189, 28);

        menuEmpStatusGH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenu.png"))); // NOI18N
        panelSideMenu.add(menuEmpStatusGH);
        menuEmpStatusGH.setBounds(6, 457, 189, 28);

        menuAbsentTypeGH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenu.png"))); // NOI18N
        panelSideMenu.add(menuAbsentTypeGH);
        menuAbsentTypeGH.setBounds(6, 489, 189, 28);

        menuOverTimeTypeGH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenu.png"))); // NOI18N
        panelSideMenu.add(menuOverTimeTypeGH);
        menuOverTimeTypeGH.setBounds(6, 521, 189, 28);

        menuSalaryTypeGH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenu.png"))); // NOI18N
        panelSideMenu.add(menuSalaryTypeGH);
        menuSalaryTypeGH.setBounds(6, 553, 189, 28);

        menuDeductionTypeGH.setIcon(new javax.swing.ImageIcon(getClass().getResource("/com/malimar/images/LeftMenu.png"))); // NOI18N
        panelSideMenu.add(menuDeductionTypeGH);
        menuDeductionTypeGH.setBounds(6, 585, 189, 28);

        getContentPane().add(panelSideMenu, java.awt.BorderLayout.LINE_START);
    ...
    private void menuHRActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_menuHRActionPerformed

    }//GEN-LAST:event_menuHRActionPerformed
    ...
    private com.xzq.osc.JocHyperlink menuBank;
    private javax.swing.JLabel menuBankG;
    private javax.swing.JLabel menuBankGH;
    ...
    private com.xzq.osc.JocHyperlink menuDepartment;
    private javax.swing.JLabel menuDepartmentG;
    private javax.swing.JLabel menuDepartmentGH;
    private com.xzq.osc.JocHyperlink menuDivision;
    private javax.swing.JLabel menuDivisionG;
    private javax.swing.JLabel menuDivisionGH;
    ...
    private com.xzq.osc.JocHyperlink menuMaximum;
    private com.xzq.osc.JocHyperlink menuMinimum;
